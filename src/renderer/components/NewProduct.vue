                  ...
                  <div class="row center-block text-center">
                    <div class="col-md-12">
                      <div class="form-group">
                        <Avatar
                          image="static/assets/img/faces/product.png"
                          :width="400"
                          :height="400"
                          :crop="true"
                          :removeable="true"
...
export default {
  ...
  created: function () {
    ...
    const last_index = _.last(this.products) ? _.last(this.products).id + 1 : 1
    console.log(last_index)
    // const last_index = Math.random().toString(36).substring(2,7).toUpperCase();
    this.product = new Product(last_index, '', '', 'piece', '', '', '', '', '', '')
